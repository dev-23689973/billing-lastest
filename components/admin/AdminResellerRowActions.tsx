...
import { resetManagerStaffPasswordAction, resetStaffPasswordAction } from "@/actions/forms";
...
import {
  staffDetailsCloseButtonClass,
  staffDetailsStatTileClass,
  staffDetailsStatValueClass,
...
export function AdminResellerRowActions({
  ...
  staffPortal?: "admin" | "manager";
}) {
  const isManagerPortal = staffPortal === "manager";
  const editorApiBase = isManagerPortal ? "/api/manager" : "/api/admin";
  const passwordResetAction = isManagerPortal ? resetManagerStaffPasswordAction : resetStaffPasswordAction;
  ...
  return (
    <div className="relative flex justify-center">
      ...
      <FloatingMenuPortal open={open} onOpenChange={setOpen} anchorRef={anchorRef}>
        ...
        <div className={floatingRowActionMenuDividerClass} onClick={(e) => e.stopPropagation()}>
          {canDelete ? (
            ...
            <ManagerDeleteResellerForm username={username} canDelete={false} buttonLabel="Delete reseller" menuItem />
          ) : (
      ...
      <StaffPasswordResetModal
        ...
        idPrefix={`reseller-reset-${username}`}
        redirectPath={redirectPath}
      />
