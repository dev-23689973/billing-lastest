import { markPortalStaffMessageReadRecipient } from "@/lib/repos/portalStaffMessages";
...
export async function POST(req: Request) {
  ...
  const ok = await markPortalStaffMessageReadRecipient(recipientId, session.username);
